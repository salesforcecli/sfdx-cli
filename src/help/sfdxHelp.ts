...
import { SfdxCommandHelp } from './sfdxCommandHelp';

export default class SfdxHelp extends Help {
  protected CommandHelpClass: typeof CommandHelp = SfdxCommandHelp;
  protected commandHelpClass: SfdxCommandHelp | undefined;
  ...
  protected getCommandHelpClass(command: Command.Cached): CommandHelp {
    this.commandHelpClass = super.getCommandHelpClass(command) as SfdxCommandHelp;
