...
//     run: (ctx: V5Context) => Promise<any>;
// }

// export function convertFromV5(c: V5Command) {
...
// function convertFlagsFromV5(flags: (V5Flag[] | { [name: string]: Flag<any> }) | null): { [name: string]: any } {
//     if (!flags) {
//         return {};
//     }
